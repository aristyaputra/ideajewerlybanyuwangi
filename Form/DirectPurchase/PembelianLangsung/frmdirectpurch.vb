...
Public Class frmdirectpurch
    ...
    Private Sub insert_data()
        ...
        If insert = 1 Then
            Call insert_cashier(Trim(txt_inv_no.Text), txt_date.Value, txt_customer_nm.Text, txt_cust_address.Text, txt_customer_phone.Text, _
                                    ...
                                    server_datetime(), username, server_datetime(), 0, "", "", 0, "", 0, 0, 0, 0, "", 0, 0, 0, txt_payterm.Text, txt_discterm.Text, Replace(txt_disc_pay.Text, "%", ""), var_chk_so, member, cbo_customer.Text, Replace(TextBox1.Text, ",", ""), 0, 0)
    ...
    Private Sub btn_del2_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btn_del2.Click
        ...
        If edit = 1 Then
            ...
            If pesan = vbYes Then
                delete_purchase_langsung(Trim(txt_inv_no.Text), txt_date.Value, txt_customer_nm.Text, txt_cust_address.Text, txt_customer_phone.Text, _
                                    var_paymethod, Replace(txt_subtotal.Text, ",", ""), Replace(txt_disc.Text, "%", ""), Replace(txt_tax.Text, "%", ""), Replace(txt_total.Text, ",", ""), txt_comment.Text, username, _
