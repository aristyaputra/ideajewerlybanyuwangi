...
Public Class frmRealisasiWO
    ...
    Private Sub fillComboBox()
        Dim DT As DataTable
        DT = getComboWO()
        txt_wo_no.Properties.DataSource = DT
        txt_wo_no.Properties.DisplayMember = "wo_no"
        txt_wo_no.Properties.ValueMember = "wo_no"
        txt_wo_no.Properties.PopulateViewColumns()
        txt_wo_no.Properties.BestFitMode = DevExpress.XtraEditors.Controls.BestFitMode.BestFitResizePopup
        txt_wo_no.Properties.View.OptionsView.ShowAutoFilterRow = True
        txt_wo_no.Properties.View.Columns("wo_no").Caption = "No SPK"
        txt_wo_no.Properties.View.Columns("department_name").Caption = "Departemen"
        txt_wo_no.Properties.View.Columns("tgl_mulai").Caption = "Tanggal Mulai"
        txt_wo_no.Properties.View.Columns("pic").Caption = "PIC"
        txt_wo_no.Properties.View.Columns("department_id").Caption = "ID Departemen"
        txt_wo_no.Properties.View.Columns("expected_date").Caption = "Tgl Ekspektasi Selesai"
        txt_wo_no.Properties.View.Columns("expected_date").DisplayFormat.FormatType = DevExpress.Utils.FormatType.DateTime
        txt_wo_no.Properties.View.Columns("expected_date").DisplayFormat.FormatString = "dd-MMM-yyyy"

        Dim DTGudang As DataTable
        DTGudang = getComboGudang()
        cbo_gudang_item.Properties.DataSource = DTGudang
        cbo_gudang_item.Properties.DisplayMember = "warehouse_name"
        cbo_gudang_item.Properties.ValueMember = "id_warehouse"
        cbo_gudang_item.Properties.PopulateViewColumns()
        cbo_gudang_item.Properties.View.Columns("id_warehouse").Caption = "Kode"
        cbo_gudang_item.Properties.View.Columns("warehouse_name").Caption = "Gudang"
        cbo_gudang_item.Properties.BestFitMode = DevExpress.XtraEditors.Controls.BestFitMode.BestFitResizePopup
        cbo_gudang_item.Properties.View.OptionsView.ShowAutoFilterRow = True
    ...
    Private Sub frmreceiptmoney_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Call insert_no_trans("REALISASI_WORKING_ORDER", Month(txt_date.Value), Year(txt_date.Value))
        Call select_control_no("REALISASI_WORKING_ORDER", "TRANS")
    ...
    Private Sub insert_data()
        ...
        If insert = 1 Then
            ...
            Call insert_realisasi_wo(Trim(txt_po_no.Text), _
                                     txt_wo_no.EditValue, Format(txt_req_date.Value, "yyyy-MM-dd"), Format(txt_real_date.Value, "yyyy-MM-dd"), _
                                     Format(txt_date.Value, "yyyy-MM-dd"), _
                                     cbo_pic.Text, lbl_department.Text, _
            ...
            For i = 0 To DataGridView1.Rows.Count - 1
                ...
                If DataGridView1.Item(1, i).Value <> Nothing Or DataGridView1.Item(1, i).Value <> "" Then
                    Call insert_realisasi_wo(Trim(txt_po_no.Text), _
                         ...
                         Replace(DataGridView1.Item(6, i).Value, ",", "") / Replace(DataGridView1.Item(7, i).Value, ",", "") * 100, _
                         "", _
                         0, _
                         "", _
                         0, _
                         ...
                         0, _
                         "", _
                         0, 1, i, "INSERT", cbo_gudang_item.EditValue)
                End If
                ...
                For x As Integer = 0 To DataGridView3.Rows.Count - 1
                    If DataGridView3.Item(1, x).Value <> Nothing Or DataGridView3.Item(1, x).Value <> "" Then
                        Call insert_realisasi_wo(Trim(txt_po_no.Text), _
                             ...
                             0, _
                             "", _
                             0, 2, x, "INSERT", cbo_gudang_item.EditValue)
                    End If
                Next
                For y As Integer = 0 To DataGridView4.Rows.Count - 1
                    If DataGridView4.Item(1, y).Value <> Nothing Or DataGridView4.Item(1, y).Value <> "" Then
                        Call insert_realisasi_wo(Trim(txt_po_no.Text), _
                             ...
                             0, _
                             "", _
                             0, 3, y, "INSERT", cbo_gudang_item.EditValue)
                    End If
                Next
                For z As Integer = 0 To DataGridView5.Rows.Count - 1
                    If DataGridView5.Item(1, z).Value <> Nothing Or DataGridView5.Item(1, z).Value <> "" Then
                        Call insert_realisasi_wo(Trim(txt_po_no.Text), _
                             ...
                             Replace(DataGridView5.Item(7, z).Value, ",", ""), 4, z, "INSERT", cbo_gudang_item.EditValue)
                    End If
                Next
                For z As Integer = 0 To DataGridView5.Rows.Count - 1
                    If DataGridView5.Item(1, z).Value <> Nothing Or DataGridView5.Item(1, z).Value <> "" Then
                        Call insert_realisasi_wo(Trim(txt_po_no.Text), _
                             ...
                             Replace(DataGridView5.Item(5, z).Value, ",", ""), _
                             DataGridView5.Item(3, z).Value, _
                             Replace(DataGridView5.Item(7, z).Value, ",", ""), 5, z, "INSERT", cbo_gudang_item.EditValue)
                    End If
                Next
            Next
            If param_sukses = True Then
                ...
                update_no_trans(txt_date.Value, "REALISASI_WORKING_ORDER")
        ...
        ElseIf edit = 1 Then
            Dim date_server As Date
            date_server = server_datetime()
            Call update_realisasi_wo(Trim(txt_po_no.Text), _
                                     txt_wo_no.EditValue, Format(txt_req_date.Value, "yyyy-MM-dd"), Format(txt_real_date.Value, "yyyy-MM-dd"), _
                                     Format(txt_date.Value, "yyyy-MM-dd"), _
                                     cbo_pic.Text, lbl_department.Text, _
                         Replace(txt_total_cost.Text, ",", ""), _
                         ...
                         0, _
                         "", _
                         0, 0, 0, "UPDATE", cbo_gudang_item.EditValue)
            For i = 0 To DataGridView1.Rows.Count - 1
                DataGridView1.CurrentCell = DataGridView1(0, i)
                If DataGridView1.Item(1, i).Value <> Nothing Or DataGridView1.Item(1, i).Value <> "" Then
                    Call update_realisasi_wo(Trim(txt_po_no.Text), _
                         ...
                         0, _
                         "", _
                         0, 1, i, "UPDATE", cbo_gudang_item.EditValue)
                End If
                ...
                For x As Integer = 0 To DataGridView3.Rows.Count - 1
                    If DataGridView3.Item(1, x).Value <> Nothing Or DataGridView3.Item(1, x).Value <> "" Then
                        Call update_realisasi_wo(Trim(txt_po_no.Text), _
                             ...
                             0, _
                             "", _
                             0, 2, x, "UPDATE", cbo_gudang_item.EditValue)
                    End If
                Next
                For y As Integer = 0 To DataGridView4.Rows.Count - 1
                    If DataGridView4.Item(1, y).Value <> Nothing Or DataGridView4.Item(1, y).Value <> "" Then
                        Call update_realisasi_wo(Trim(txt_po_no.Text), _
                             ...
                             0, _
                             "", _
                             0, 3, y, "UPDATE", cbo_gudang_item.EditValue)
                    End If
                Next
                For z As Integer = 0 To DataGridView5.Rows.Count - 1
                    If DataGridView5.Item(1, z).Value <> Nothing Or DataGridView5.Item(1, z).Value <> "" Then
                        Call update_realisasi_wo(Trim(txt_po_no.Text), _
                             ...
                             Replace(DataGridView5.Item(5, z).Value, ",", ""), _
                             DataGridView5.Item(3, z).Value, _
                             Replace(DataGridView5.Item(7, z).Value, ",", ""), 4, z, "UPDATE", cbo_gudang_item.EditValue)
                    End If
                Next
                For z As Integer = 0 To DataGridView5.Rows.Count - 1
                    If DataGridView5.Item(1, z).Value <> Nothing Or DataGridView5.Item(1, z).Value <> "" Then
                        Call update_realisasi_wo(Trim(txt_po_no.Text), _
                             ...
                             Replace(DataGridView5.Item(5, z).Value, ",", ""), _
                             DataGridView5.Item(3, z).Value, _
                             Replace(DataGridView5.Item(7, z).Value, ",", ""), 5, z, "UPDATE", cbo_gudang_item.EditValue)
                    End If
                Next
            Next
            If param_sukses = True Then
    ...
    Private Sub clean()
        ...
        With Me
            ...
            .lbl_department.text = Nothing
            .lbl_pic.Text = Nothing
            .txt_wo_no.EditValue = Nothing
        End With
        Call select_control_no("REALISASI_WORKING_ORDER", "TRANS")
        txt_po_no.Text = no_master
    ...
    Private Sub DataGridView1_CellEndEdit(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles DataGridView1.CellEndEdit
        ...
        If columnIndex = 4 Or columnIndex = 6 Then
            ...
            If Not IsNumeric(DataGridView1.Item(4, DataGridView1.CurrentCell.RowIndex).Value) Then
                ...
                Exit Sub
            Else
                DataGridView1.Item(6, DataGridView1.CurrentCell.RowIndex).Value = FormatNumber(DataGridView1.Item(7, DataGridView1.CurrentCell.RowIndex).Value / DataGridView1.Item(4, DataGridView1.CurrentCell.RowIndex).Value, 0)
            End If
        End If
    ...
    Private Sub GridList_Customer_DoubleClick(sender As Object, e As System.EventArgs) Handles GridList_Customer.DoubleClick
        ...
        detail(GridList_Customer.GetRowCellValue(GridList_Customer.FocusedRowHandle, "realized_no"))
    End Sub
    ...
    Private Sub view_data()
        ...
        Try
            ...
            ElseIf chk_date.Checked = False Then
                date_filter = 0
            End If
            DT = select_realisasi_working_order(Trim(txt_search.Text), 0, date_filter, Format(tglawal.Value, "yyyy-MM-dd"), Format(tglakhir.Value, "yyyy-MM-dd"))
            GridControl.DataSource = DT
            GridList_Customer.Columns("realized_no").Caption = "No Produksi"
            GridList_Customer.Columns("realized_no").Width = 170
            ...
            GridList_Customer.Columns("pic").Width = 200
            ...
            GridList_Customer.Columns("cost_total").Width = 170
    ...
    Private Sub detail(ByVal criteria As String)
        ...
        Try
            ...
            DT = select_realisasi_working_order(criteria, 0, date_filter, Format(tglawal.Value, "yyyy-MM-dd"), Format(tglakhir.Value, "yyyy-MM-dd"))
            rows = DT.Rows.Count
            If DT.Rows.Count > 0 Then
                ...
                txt_po_no.Text = DT.Rows(0).Item("realized_no")
                txt_wo_no.EditValue = DT.Rows(0).Item("wo_no")
                ...
                lbl_pic.Text = DT.Rows(0).Item("pic")
                lbl_department.Text = DT.Rows(0).Item("department_id")
                cbo_gudang_item.EditValue = DT.Rows(0).Item("id_warehouse")
                txt_date.Enabled = False
                DataGridView1.Rows.Clear()
                DataGridView1.Rows.Add(1)
                ...
                DTDetail = select_realisasi_working_order(criteria, 1, date_filter, Format(tglawal.Value, "yyyy-MM-dd"), Format(tglakhir.Value, "yyyy-MM-dd"))
                ...
                For i As Integer = 0 To rows - 1
                    ...
                    DataGridView1.Item(1, i).Value = DTDetail.Rows(i).Item("id_item")
                    DataGridView1.Item(2, i).Value = DTDetail.Rows(i).Item("item_name")
                    DataGridView1.Item(4, i).Value = FormatNumber(DTDetail.Rows(i).Item("qty_item_production"), 0)
                    DataGridView1.Item(3, i).Value = FormatNumber(DTDetail.Rows(i).Item("qty_wo"), 0)
                    DataGridView1.Item(5, i).Value = DTDetail.Rows(i).Item("id_unit")
                    DataGridView1.Item(6, i).Value = FormatNumber(DTDetail.Rows(i).Item("qtyperunit"), 0)
                    DataGridView1.Item(7, i).Value = FormatNumber(DTDetail.Rows(i).Item("cost_total"), 0)
                    totalItemProduksi = totalItemProduksi + Replace(DTDetail.Rows(i).Item("cost_total"), ",", "")
                    ' DataGridView1.CurrentCell = DataGridView1(0, i)
                Next
                ...
                DTDetail = select_realisasi_working_order(criteria, 2, date_filter, Format(tglawal.Value, "yyyy-MM-dd"), Format(tglakhir.Value, "yyyy-MM-dd"))
                rows = DTDetail.Rows.Count
                Dim totalItemMaterial As Double
                DataGridView3.Rows.Clear()
                For i As Integer = 0 To rows - 1
                    DataGridView3.Rows.Add()
                    DataGridView3.Item(0, i).Value = i + 1
                    DataGridView3.Item(1, i).Value = DTDetail.Rows(i).Item("id_item_material")
                    DataGridView3.Item(2, i).Value = DTDetail.Rows(i).Item("item_name")
                    DataGridView3.Item(3, i).Value = DTDetail.Rows(i).Item("notes_material")
                    DataGridView3.Item(4, i).Value = FormatNumber(DTDetail.Rows(i).Item("qty_material"), 0)
                    DataGridView3.Item(5, i).Value = DTDetail.Rows(i).Item("id_unit_material")
                    DataGridView3.Item(6, i).Value = FormatNumber(DTDetail.Rows(i).Item("material_cost"), 0)
                    DataGridView3.Item(7, i).Value = FormatNumber(DTDetail.Rows(i).Item("total_cost_material"), 0)
                    totalItemMaterial = totalItemMaterial + Replace(DTDetail.Rows(i).Item("total_cost_material"), ",", "")
                    ' DataGridView1.CurrentCell = DataGridView1(0, i)
                Next
                txt_total.Text = FormatNumber(totalItemMaterial, 0)


                DTDetail = select_realisasi_working_order(criteria, 3, date_filter, Format(tglawal.Value, "yyyy-MM-dd"), Format(tglakhir.Value, "yyyy-MM-dd"))
                rows = DTDetail.Rows.Count
                Dim totalItemWIP As Double
                DataGridView4.Rows.Clear()
                For i As Integer = 0 To rows - 1
                    DataGridView4.Rows.Add()
                    DataGridView4.Item(0, i).Value = i + 1
                    DataGridView4.Item(1, i).Value = DTDetail.Rows(i).Item("id_item_material")
                    DataGridView4.Item(2, i).Value = DTDetail.Rows(i).Item("item_name")
                    DataGridView4.Item(3, i).Value = DTDetail.Rows(i).Item("notes_material")
                    DataGridView4.Item(4, i).Value = FormatNumber(DTDetail.Rows(i).Item("qty_material"), 0)
                    DataGridView4.Item(5, i).Value = DTDetail.Rows(i).Item("id_unit_material")
                    DataGridView4.Item(6, i).Value = FormatNumber(DTDetail.Rows(i).Item("material_cost"), 0)
                    DataGridView4.Item(7, i).Value = FormatNumber(DTDetail.Rows(i).Item("total_cost_material"), 0)
                    totalItemWIP = totalItemWIP + Replace(DTDetail.Rows(i).Item("total_cost_material"), ",", "")
                    ' DataGridView1.CurrentCell = DataGridView1(0, i)
                Next
                txt_total_wip.Text = FormatNumber(totalItemWIP, 0)


                DTDetail = select_realisasi_working_order(criteria, 4, date_filter, Format(tglawal.Value, "yyyy-MM-dd"), Format(tglakhir.Value, "yyyy-MM-dd"))
                rows = DTDetail.Rows.Count
                Dim totalItemConversion As Double
                DataGridView5.Rows.Clear()
                For i As Integer = 0 To rows - 1
                    DataGridView5.Rows.Add()
                    DataGridView5.Item(0, i).Value = i + 1
                    DataGridView5.Item(1, i).Value = DTDetail.Rows(i).Item("id_cost_konversi")
                    DataGridView5.Item(2, i).Value = DTDetail.Rows(i).Item("cost_name")
                    DataGridView5.Item(3, i).Value = DTDetail.Rows(i).Item("notes_konversi")
                    DataGridView5.Item(4, i).Value = FormatNumber(DTDetail.Rows(i).Item("qty_hour"), 0)
                    DataGridView5.Item(5, i).Value = FormatNumber(DTDetail.Rows(i).Item("cost_konversi"), 0)
                    DataGridView5.Item(7, i).Value = FormatNumber(DTDetail.Rows(i).Item("qty_hour") * DTDetail.Rows(i).Item("cost_konversi"), 0)
                    totalItemConversion = totalItemConversion + Replace(DTDetail.Rows(i).Item("qty_hour") * DTDetail.Rows(i).Item("cost_konversi"), ",", "")
                    ' DataGridView1.CurrentCell = DataGridView1(0, i)
                Next
                txt_total_konversi.Text = FormatNumber(totalItemConversion, 0)
            End If
    ...
    Private Sub btn_del2_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_del2.Click
        ...
        If edit = 1 Then
            If getTemplateAkses(username, "MN_PRODUCTION_DELETE") <> True Then
        ...
        If edit = 1 Then
            ...
            If pesan = vbYes Then
                Call delete_realisasi_wo(Trim(txt_po_no.Text), _
                                     txt_wo_no.EditValue, Format(txt_req_date.Value, "yyyy-MM-dd"), Format(txt_real_date.Value, "yyyy-MM-dd"), _
                                     Format(txt_date.Value, "yyyy-MM-dd"), _
                                     cbo_pic.Text, lbl_department.Text, _
                         Replace(txt_total_cost.Text, ",", ""), _
                         ...
                         0, _
                         "", _
                         0, 0, 0, "DELETE", cbo_gudang_item.EditValue)
                If param_sukses = True Then
    ...
    Private Sub txt_date_ValueChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles txt_date.ValueChanged, txt_req_date.ValueChanged
        ...
        If insert = 1 Then
            ...
            txt_po_no.Text = no_master
        End If
        ' txt_date.Value = txt_req_date.Value
    End Sub
    ...
    Private Sub btn_save2_Click_1(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_save2.Click
        open_conn()
        If insert = 1 Then
            If getTemplateAkses(username, "MN_PRODUCTION_ADD") <> True Then
                Dim info As AlertInfo = New AlertInfo("Cek Kevaliditasan Data", "Anda tidak memiliki hak akses")
                alertControl_warning.Show(Me, info)
                Exit Sub
            End If
        ...
        If edit = 1 Then
            If getTemplateAkses(username, "MN_PRODUCTION_EDIT") <> True Then
                Dim info As AlertInfo = New AlertInfo("Cek Kevaliditasan Data", "Anda tidak memiliki hak akses")
                alertControl_warning.Show(Me, info)
                Exit Sub
            End If
    ...
    Private Sub txt_wo_no_EditValueChanged(sender As Object, e As System.EventArgs) Handles txt_wo_no.EditValueChanged
        If txt_wo_no.EditValue <> Nothing Then

            If insert = 1 Then
                pesan = MsgBox("Pastikan Seluruh Proses Input Penggunaan Bahan " & vbCrLf & "Telah Selesai", MsgBoxStyle.OkCancel)
            ...
            Dim row As DataRowView
            Dim total_cost As Double
            row = TryCast(txt_wo_no.Properties.GetRowByKeyValue(txt_wo_no.EditValue), DataRowView)
            txt_dep_nm.Text = row.Item("department_name")
            lbl_department.Text = row.Item("department_id")
            txt_req_date.Value = row.Item("expected_date")
            cbo_pic.Text = row.Item("pic")
            DataGridView1.Rows.Clear()
            DataGridView3.Rows.Clear()
            DataGridView4.Rows.Clear()
            DataGridView5.Rows.Clear()
            ...
            DTItem = getWOItemDet(txt_wo_no.EditValue)
            For i As Integer = 0 To DTItem.Rows.Count - 1
                DataGridView1.Rows.Add(1)
                DataGridView1.Item(0, i).Value = i + 1
                DataGridView1.Item(1, i).Value = DTItem.Rows(i).Item("id_item")
                DataGridView1.Item(2, i).Value = DTItem.Rows(i).Item("item_name")
                DataGridView1.Item(3, i).Value = FormatNumber(DTItem.Rows(i).Item("qty_item_production"), 0)
                DataGridView1.Item(4, i).Value = FormatNumber(0, 0)
                DataGridView1.Item(5, i).Value = DTItem.Rows(i).Item("id_unit")
                DataGridView1.Item(6, i).Value = FormatNumber(0, 0)
                DataGridView1.Item(7, i).Value = FormatNumber(DTItem.Rows(i).Item("cost_total_wo"), 0)
                totalItem = totalItem + Replace(DataGridView1.Item(7, i).Value, ",", "")
            Next


            Dim DTMaterial As DataTable
            Dim totalmaterial As Double
            DTMaterial = getUsageMaterial_materialDet(txt_wo_no.EditValue)
            For i As Integer = 0 To DTMaterial.Rows.Count - 1
                DataGridView3.Rows.Add(1)
                DataGridView3.Item(0, i).Value = i + 1
                DataGridView3.Item(1, i).Value = DTMaterial.Rows(i).Item("id_item_material")
            ...
            Dim DTWIP As DataTable
            Dim totalwip As Double
            DTWIP = getUsageMaterial_WIPDet(txt_wo_no.EditValue)
            For i As Integer = 0 To DTWIP.Rows.Count - 1
                DataGridView4.Rows.Add(1)
                DataGridView4.Item(0, i).Value = i + 1
                DataGridView4.Item(1, i).Value = DTWIP.Rows(i).Item("id_item_wip")
            ...
            Dim DTConversion As DataTable
            Dim totalkonversi As Double
            DTConversion = getWOConversionDet(txt_wo_no.EditValue)
            For i As Integer = 0 To DTConversion.Rows.Count - 1
                DataGridView5.Rows.Add(1)
                DataGridView5.Item(0, i).Value = i + 1
                DataGridView5.Item(1, i).Value = DTConversion.Rows(i).Item("id_cost_konversi")
                ...
                DataGridView5.Item(4, i).Value = FormatNumber(DTConversion.Rows(i).Item("qty_hour"), 0)
                DataGridView5.Item(5, i).Value = FormatNumber(DTConversion.Rows(i).Item("cost_konversi"), 0)
                DataGridView5.Item(7, i).Value = FormatNumber(DTConversion.Rows(i).Item("total_cost_konversi"), 0)
                totalkonversi = totalkonversi + Replace(DataGridView5.Item(7, i).Value, ",", "")
            Next
            txt_total_konversi.Text = FormatNumber(totalkonversi, 0)
            txt_total_cost.Text = FormatNumber(totalmaterial + totalwip + totalkonversi, 0)
            DataGridView1.Item(7, 0).Value = FormatNumber(totalmaterial + totalwip + totalkonversi, 0)
        End If
    End Sub
    ...
    Private Sub DataGridView5_CellEndEdit(sender As Object, e As System.Windows.Forms.DataGridViewCellEventArgs) Handles DataGridView5.CellEndEdit
        DataGridView5.Item(7, DataGridView5.CurrentCell.RowIndex).Value = FormatNumber(DataGridView5.Item(4, DataGridView5.CurrentCell.RowIndex).Value * DataGridView5.Item(5, DataGridView5.CurrentCell.RowIndex).Value, 0)
        hitung_biaya()
    End Sub

    Private Sub hitung_biaya()
        Dim totalmaterial, totalwip, totalkonversi As Double
        ...
        txt_total_cost.Text = FormatNumber(totalmaterial + totalwip + totalkonversi, 0)
        DataGridView1.Item(7, 0).Value = FormatNumber(totalmaterial + totalwip + totalkonversi, 0)
        If IsNumeric(DataGridView1.Item(4, 0).Value) = True And DataGridView1.Item(4, 0).Value > 0 Then
            DataGridView1.Item(6, 0).Value = FormatNumber(DataGridView1.Item(7, 0).Value / DataGridView1.Item(4, 0).Value, 0)
        End If
    End Sub
