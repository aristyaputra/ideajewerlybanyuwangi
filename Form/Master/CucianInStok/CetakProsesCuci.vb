...
Public Class CetakProsesCuci
    ...
    Private Sub Form1_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Try
            ...
            pathfilereport = Application.StartupPath & "\Report\CetakProsesCuci.rpt"
            Dim da As New MySqlDataAdapter()
            Dim ds As New DataSet()
            Dim qryCompanies As String = "SELECT * FROM cetak_cucian_inprocess_view"
            ...
            R.Refresh()
            'R.RecordSelectionFormula = "{view_ctk_so1.no_sales} ='" & frmPayUMSO.NoBuktiFaktur & "'"
            With CRviewer
                .ReportSource = R
