...
Public Class frmkatbarang
    ...
    Private Sub frmkatbarang_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Call insert_no_item("MASTER_ITEM_KATEGORI_NEW", Month(server_datetime()), Year(server_datetime()), "", "")
        Call select_control_no_item("MASTER_ITEM_KATEGORI_NEW", "TRANS", "", "")
    ...
    Public Sub insert_data()
        ...
        If insert = 1 Then
            ...
            If param_sukses = True Then
                ...
                update_no_item_type(server_datetime(), "MASTER_ITEM_KATEGORI_NEW", "", "")
                clean()
            Else
    ...
    Private Sub view_data()
        ...
        GridList_Customer.Columns("mst_itemjenis_nm").Visible = False
