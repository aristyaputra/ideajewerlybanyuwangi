...
Public Class frmjenisbarang
    ...
    Public Sub insert_data()
        open_conn()
        If insert = 1 Then
            Call insert_itemjenis(Trim(txtkode.Text), Trim(txtnama.Text), Trim(txtket.Text), "INSERT", Replace(txt_disc.Text, ",", ""), Replace(txt_default_price.Text, ",", ""))
            ...
            End If
        ElseIf edit = 1 Then
            Call update_itemjenis(Trim(txtkode.Text), Trim(txtnama.Text), Trim(txtket.Text), "UPDATE", Replace(txt_disc.Text, ",", ""), Replace(txt_default_price.Text, ",", ""))
            If param_sukses = True Then
    ...
    Private Sub view_data()
        ...
        GridList_Customer.Columns("default_price").Caption = "Harga Per Gram"
        GridList_Customer.Columns("default_price").Width = 140
        GridList_Customer.Columns("default_price").DisplayFormat.FormatString = "N0"
        GridList_Customer.Columns("default_price").DisplayFormat.FormatType = DevExpress.Utils.FormatType.Numeric
