...
Public Class FormCtkAdjustJurnal
    ...
    Private Sub Form1_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Try
            ...
            pathfilereport = Application.StartupPath & "\Report\BuktiJurnalPenyesuaian.rpt"
            Dim da As New MySqlDataAdapter()
            Dim ds As New DataSet()
            Dim qryCompanies As String = "SELECT * FROM view_ctk_adjustjurnal where journal_no = '" & frmjournal.NoJurnal & "'"
