...
Public Class frmsetcadpiutang
    ...
    Private Sub view_data()
        ...
        DT = select_set_cadangan_ar()
        GridControl.DataSource = DT
        GridList_Customer.Columns("id_cadangan").Caption = "ID Cadangan"
        GridList_Customer.Columns("id_cadangan").Width = 100
        GridList_Customer.Columns("umur_piutang").Caption = "Umur Piutang"
        GridList_Customer.Columns("umur_piutang").Width = 120
        ...
        '        DataGridView2.Item(1, i).Value = DT.Rows(i).Item("umur_piutang")
    ...
    Private Sub btn_save2_Click(sender As System.Object, e As System.EventArgs) Handles btn_save2.Click
        ...
        Call update_set_cadangan_ar(Replace(txt_blm_jt.Text, ",", ""), Replace(txt_1.Text, ",", ""), Replace(txt_2.Text, ",", ""), Replace(txt_3.Text, ",", ""), Replace(txt_4.Text, ",", ""), Replace(txt_5.Text, ",", ""), Format(server_datetime(), "yyyy-MM-dd"), username)
    ...
    Private Sub frmsetcadpiutang_Activated(sender As Object, e As System.EventArgs) Handles Me.Activated
