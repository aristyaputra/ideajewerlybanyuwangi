...
Public Class frm_display_cashier
    Dim i As Integer
    Public formsource_sales_return As Boolean
    Public formsource_cashier_return As Boolean
    ...
    Public Sub view_data()
        ...
        Dim Rows As Integer
        Dim DT As DataTable
        DT = select_cashier2(cbo_search.Text, txt_search.Text, 0)
        ...
        For i = 0 To Rows
            ...
            DataGridView1.Item(1, i).Value = Format(DT.Rows(i).Item("date_trn"), "dd-MMM-yyyy")
            DataGridView1.Item(2, i).Value = DT.Rows(i).Item("customer")
            DataGridView1.Item(3, i).Value = DT.Rows(i).Item("cust_address")
            DataGridView1.Item(4, i).Value = DT.Rows(i).Item("no_sales")
    ...
    Private Sub frm_display_purchase_FormClosed(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
        'open_conn()
        'If formsource_cashier_return = True Then
        '    formsource_cashier_return = False
        '    With frmcashierreturn
        '        .Enabled = True
    ...
    Private Sub generate()
        ...
        If formsource_cashier_return = True Then
            ...
            With frmcashierreturn
                ...
                End If
                .txt_kurs.Text = FormatNumber(1, 0)
            End With
            MainMenu.Enabled = True
        End If
        Me.Close()
