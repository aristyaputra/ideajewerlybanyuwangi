...
Public Class frm_display_item
    ...
    Private Sub view_data()
        ...
        Try
            ...
            If formsource_sales_item = True Then
                ...
                DT = select_item_stok_aktif(Trim(cbo_search.Text), Trim(txt_search.Text), Trim(cbo_search2.Text), Trim(txt_search2.Text))
            Else
                DT = select_item_all(Trim(cbo_search.Text), Trim(txt_search.Text), Trim(cbo_search2.Text), Trim(txt_search2.Text))
            End If
            ...
            DataGridView1.Columns(9).DataPropertyName = "kadar"
            DataGridView1.Columns(10).DataPropertyName = "weight"
    ...
    Private Sub txt_search_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles txt_search.KeyDown, txt_search2.KeyDown
        open_conn()
    ...
    Private Sub txt_search_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles txt_search.TextChanged, txt_search2.TextChanged
        open_conn()
        If Len(txt_search.Text) = 8 And Trim(cbo_search.Text) = "ID" Then
            view_data()
            If DataGridView1.Rows.Count > 0 Then
                DataGridView1_DoubleClick(sender, e)
            Else
                Dim info As AlertInfo = New AlertInfo("Warning", "Stok " & Trim(txt_search.Text) & " Kosong")
