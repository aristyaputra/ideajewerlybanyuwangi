...
Public Class frmcashierregister
    ...
    Private Sub ComboBox4_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        open_conn()
        'Dim FrmAccount As New frm_display_acc_cashier
        'FrmAccount.Show()
        ''   FrmAccount.MdiParent = MainMenu
        'FrmAccount.formsource_cashier = True
        'datagrid_layout()
        'Me.Enabled = False
    End Sub

    Private Sub frmcashierregister_Activated(sender As Object, e As System.EventArgs) Handles Me.Activated
    ...
    Private Sub LoadComboBox_MtgcComboBoxAcc()
        ...
        dtLoading = select_combo_cashier()
    ...
    Private Sub Button2_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button2.Click
        ...
        Try
            ...
            Dim LapDataCustomer_1 As New FormLapCashierReg
            LapDataCustomer_1.Show()
            LapDataCustomer_1.Text = "Laporan Kasir Register"
    ...
    Private Sub frmcashierregister_SizeChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.SizeChanged
        'open_conn()
    ...
    Private Sub cbo_search_SelectedIndexChanged_1(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cbo_search.SelectedIndexChanged
    ...
    Private Sub btn_cari_cust3_MouseHover(sender As System.Object, e As System.EventArgs)

    End Sub

    Private Sub btn_cari_cust3_MouseLeave(sender As System.Object, e As System.EventArgs)

    End Sub

    Private Sub btn_cari_cust3_Click(sender As System.Object, e As System.EventArgs)

    End Sub

    Private Sub btn_reset_cust_MouseHover(sender As System.Object, e As System.EventArgs)

    End Sub

    Private Sub btn_reset_cust_MouseLeave(sender As System.Object, e As System.EventArgs)
