    ...
    Public Sub insert_data()
        ...
        If insert = 1 Then
            Call insert_cashier_return(Trim(txt_return_no.Text), Format(txt_date.Value, "yyyy-MM-dd"), Trim(txt_cust_nm.Text), _
                                    ...
                                    0, "", "", 0, "", 0, 0, "", cbo_sales_no.Text, 0, 0, "INSERT", return_value_bef, Replace(txt_kurs.Text, ",", ""), cbo_filterwh_purch1.EditValue, txt_cust_address.Text, 0, 0, 0, 0)
                ...
                If DataGridView1.Item(9, i).Value = True Then
                    Call insert_cashier_return(Trim(txt_return_no.Text), Format(txt_date.Value, "yyyy-MM-dd"), Trim(txt_cust_nm.Text), _
                                    ...
                                    DataGridView1.Item(4, i).Value, DataGridView1.Item(5, i).Value, _
                                     ...
                                     "", cbo_sales_no.Text, 1, 1, "INSERT", return_value_bef, Replace(txt_kurs.Text, ",", ""), cbo_filterwh_purch1.EditValue, txt_cust_address.Text, Replace(DataGridView1.Item(7, i).Value, ",", ""), Replace(DataGridView1.Item(8, i).Value, ",", ""), Replace(DataGridView1.Item(10, i).Value, ",", ""), Replace(DataGridView1.Item(11, i).Value, ",", ""))
                End If
            Next
        ...
        ElseIf edit = 1 Then
            Call update_cashier_return(Trim(txt_return_no.Text), Format(txt_date.Value, "yyyy-MM-dd"), Trim(txt_idsupplier.Text), _
                                    ...
                                    Replace(txt_total.Text, ",", ""), Trim(txt_comment.Text), username, Format(server_datetime(), "yyyy-MM-dd"), username, _
                                    Format(server_datetime(), "yyyy-MM-dd"), _
                                    0, "", "", 0, "", 0, 0, "", cbo_sales_no.Text, 0, 0, "UPDATE", return_value_bef, Replace(txt_kurs.Text, ",", ""), cbo_filterwh_purch1.EditValue, txt_cust_address.Text, 0, 0, 0, 0)
            For i = 0 To DataGridView1.Rows.Count - 1
                If DataGridView1.Item(8, i).Value = True Then
                    Call update_cashier_return(Trim(txt_return_no.Text), Format(txt_date.Value, "yyyy-MM-dd"), Trim(txt_idsupplier.Text), _
                                    ...
                                    DataGridView1.Item(4, i).Value, DataGridView1.Item(5, i).Value, _
                                     Replace(DataGridView1.Item(6, i).Value, ",", ""), _
                                     "", cbo_sales_no.Text, 1, 1, "UPDATE", return_value_bef, Replace(txt_kurs.Text, ",", ""), cbo_filterwh_purch1.EditValue, txt_cust_address.Text, Replace(DataGridView1.Item(7, i).Value, ",", ""), Replace(DataGridView1.Item(8, i).Value, ",", ""), Replace(DataGridView1.Item(10, i).Value, ",", ""), Replace(DataGridView1.Item(11, i).Value, ",", ""))
                End If
            Next
            If param_sukses = True Then
