...
Public Class frmEventAttendance
    ...
    Private Sub Timer1_Tick(sender As System.Object, e As System.EventArgs) Handles Timer1.Tick
        txt_attendance.Value = server_datetime()
    End Sub
    ...
    Private Sub clean()
        ...
        txt_save_path.Text = Application.StartupPath & "\" & txt_id_member2.Text & Format(server_datetime(), "dd") & Format(server_datetime(), "MM") & Format(server_datetime(), "yyyy") & Format(server_datetime(), "ss") & ".jpg"
    ...
    Public Sub insert_data()
        ...
        If insert = 1 Then
            Call insert_event_attendance(txt_eventid.EditValue, Trim(txt_memberid.Text), Format(txt_attendance.Value, "yyyy-MM-dd hh:mm:ss"), Trim(txt_id_member2.Text), Format(server_datetime(), "yyyy-MM-dd hh:mm:ss"), Format(server_datetime(), "yyyy-MM-dd hh:mm:ss"), username, username, "INSERT")
            If param_sukses = True Then
                ...
                'End If
                update_no_trans(server_datetime(), "MASTER_EVENT_ATTENDANCE")
                clean()
            Else
            ...
            End If
        ElseIf edit = 1 Then
            Call update_event_attendance(Trim(txt_eventid.EditValue), Trim(txt_memberid.Text), Format(txt_attendance.Value, "yyyy-MM-dd hh:mm:ss"), Trim(txt_id_member2.Text), Format(server_datetime(), "yyyy-MM-dd hh:mm:ss"), Format(server_datetime(), "yyyy-MM-dd hh:mm:ss"), username, username, "UPDATE")
            If param_sukses = True Then
    ...
    Private Function getKodeEvent() As String
        Try
            ...
            Call insert_no_trans("MASTER_EVENT_ATTENDANCE", var_bulan, var_tahun)
            Call select_control_no("MASTER_EVENT_ATTENDANCE", "TRANS")
            Return no_master
    ...
    Private Sub btn_save2_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_save2.Click
        ...
        End If
        If insert = 1 Then
            If getTemplateAkses(username, "MN_ATTENDANCE_EVENT_ADD") <> True Then
        ...
        If edit = 1 Then
            If getTemplateAkses(username, "MN_ATTENDANCE_EVENT_EDIT") <> True Then
                Dim info As AlertInfo = New AlertInfo("Cek Kevaliditasan Data Hak Akses", "Anda tidak memiliki hak akses!")
                alertControl_warning.Show(Me, info)
                Exit Sub
            End If
    ...
    Private Sub btn_del2_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_del2.Click
        ...
        If edit = 1 Then
            If getTemplateAkses(username, "MN_ATTENDANCE_EVENT_DELETE") <> True Then
                Dim info As AlertInfo = New AlertInfo("Cek Kevaliditasan Data Hak Akses", "Anda tidak memiliki hak akses!")
                alertControl_warning.Show(Me, info)
                Exit Sub
            End If
        ...
        If edit = 1 Then
            pesan = MessageBox.Show("Data kehadiran akan di hapus?", "Hapus Data", MessageBoxButtons.YesNo)
            If pesan = vbYes Then
                Call delete_evt_attendance(Trim(txt_eventid.EditValue), Trim(txt_memberid.Text), Format(txt_attendance.Value, "yyyy-MM-dd hh:mm:ss"), Trim(txt_id_member2.Text), Format(server_datetime(), "yyyy-MM-dd hh:mm:ss"), Format(server_datetime(), "yyyy-MM-dd hh:mm:ss"), username, username, "INSERT")
                If param_sukses = True Then
    ...
    Private Sub view_data_event_member()
        open_conn()
        Dim i As Integer
        Dim Rows As Integer
        Dim DT As DataTable
        DT = select_event_member_attendance(txt_eventid.EditValue)
        txt_nip.Properties.DataSource = DT
        txt_nip.Properties.ValueMember = "nip_member"
        txt_nip.Properties.DisplayMember = "nip_member"
        txt_nip.Properties.PopulateViewColumns()
        datagridLayoutMember()
    End Sub
    ...
    Private Sub datagridLayoutMember()
        With txt_nip
            .Properties.View.Columns("created_date").Visible = False
            .Properties.View.Columns("modified_date").Visible = False
            .Properties.View.Columns("created_user").Visible = False
            .Properties.View.Columns("modified_user").Visible = False
            .Properties.View.Columns("id_event").Visible = False
            .Properties.View.Columns("photo_path").Visible = False
            .Properties.View.Columns("id_member").Caption = "ID MEMBER"
            .Properties.View.Columns("nip_member").Caption = "NIP"
            .Properties.View.Columns("member_name").Caption = "NAMA MEMBER"
            .Properties.View.Columns("position").Caption = "POSISI"
            .Properties.View.Columns("area").Caption = "AREA"
            .Properties.View.Columns("region").Caption = "REGION"
            .Properties.View.Columns("member_name").FilterMode = DevExpress.XtraGrid.ColumnFilterMode.DisplayText
            .Properties.View.Columns("id_member").OptionsColumn.AllowEdit = False
            .Properties.View.Columns("nip_member").OptionsColumn.AllowEdit = False
            .Properties.View.Columns("member_name").OptionsColumn.AllowEdit = False
            .Properties.View.Columns("position").OptionsColumn.AllowEdit = False
            .Properties.View.Columns("area").OptionsColumn.AllowEdit = False
            .Properties.View.Columns("region").OptionsColumn.AllowEdit = False
            .Properties.View.Columns("id_member").OptionsFilter.AllowFilter = True
            .Properties.View.Columns("nip_member").OptionsFilter.AllowFilter = True
            .Properties.View.Columns("member_name").OptionsFilter.AllowFilter = True
            .Properties.View.Columns("position").OptionsFilter.AllowFilter = True
            .Properties.View.Columns("area").OptionsFilter.AllowFilter = True
            .Properties.View.Columns("region").OptionsFilter.AllowFilter = True
            .Properties.View.Columns("id_member").OptionsFilter.AllowAutoFilter = True
            .Properties.View.Columns("nip_member").OptionsFilter.AllowAutoFilter = True
            .Properties.View.Columns("member_name").OptionsFilter.AllowAutoFilter = True
            .Properties.View.Columns("position").OptionsFilter.AllowAutoFilter = True
            .Properties.View.Columns("area").OptionsFilter.AllowAutoFilter = True
            .Properties.View.Columns("region").OptionsFilter.AllowAutoFilter = True
            .Properties.View.Columns("id_member").BestFit()
            .Properties.View.Columns("nip_member").BestFit()
            .Properties.View.Columns("member_name").BestFit()
            .Properties.View.Columns("position").BestFit()
            .Properties.View.Columns("area").BestFit()
            .Properties.View.Columns("region").BestFit()
            .Properties.View.OptionsCustomization.AllowGroup = False
            .Properties.View.OptionsCustomization.AllowFilter = True
            .Properties.View.OptionsCustomization.AllowColumnMoving = True
            .Properties.View.OptionsCustomization.AllowColumnResizing = True
    ...
    Private Sub datagridLayout()
        With GridView1
            ...
            .Columns("event_name").Visible = False
            .Columns("start_date").Visible = False
            .Columns("end_date").Visible = False
            .Columns("id_attendance").Visible = False
            ...
            .Columns("status_hadir").Caption = "STATUS"
            .Columns("attendance_date").Caption = "TGL & JAM HADIR"
            ...
            .Columns("status_hadir").OptionsColumn.AllowEdit = False
            .Columns("attendance_date").OptionsColumn.AllowEdit = False
            ...
            .Columns("status_hadir").OptionsFilter.AllowFilter = True
            .Columns("attendance_date").OptionsFilter.AllowFilter = True
            ...
            .Columns("status_hadir").OptionsFilter.AllowAutoFilter = True
            .Columns("attendance_date").OptionsFilter.AllowAutoFilter = True
            ...
            .Columns("status_hadir").BestFit()
            .Columns("attendance_date").BestFit()
    ...
    Private Sub detail(ByVal criteria As String)
        open_conn()
        Dim DT As DataTable
        DT = detail_event_attendance(criteria)
        txt_memberid.Text = DT.Rows(0).Item("id_attendance")
        txt_id_member2.Text = DT.Rows(0).Item("id_member")
        ...
        txt_nip.EditValue = DT.Rows(0).Item("nip_member")
        ...
        txt_status.Text = DT.Rows(0).Item("status_hadir")
        txt_attendance.Text = DT.Rows(0).Item("attendance_date")
    ...
    Private Sub txt_nip_EditValueChanged(sender As System.Object, e As System.EventArgs) Handles txt_nip.EditValueChanged
        On Error Resume Next
        Dim row As DataRowView
        row = TryCast(txt_nip.Properties.GetRowByKeyValue(txt_nip.EditValue), DataRowView)
        txt_nama.Text = row.Item("member_name")
        txt_posisi.Text = row.Item("position")
        txt_area.Text = row.Item("area")
        txt_region.Text = row.Item("region")
        txt_id_member2.Text = row.Item("id_member")
        txt_status.Text = "HADIR"
        txt_temp.Text = row.Item("photo_path")
        If row.Item("photo_path").ToString = "" Then
        Else
            If System.IO.File.Exists(row.Item("photo_path")) Then
                txt_photo.Image = Image.FromFile(row.Item("photo_path"))
            Else
                filename = Application.StartupPath & "\photo\no-image.jpg"
                txt_photo.Image = Image.FromFile(filename)
            End If
