    ...
    Private Sub insert_data()
        ...
        If insert = 1 Then
            Call insert_sales_order_um(Trim(txt_so_no.Text), cbo_customer.Text, txt_date.Value, txt_comment.Text, Replace(txt_subtotal.Text, ",", ""), _
                                ...
                                0, "", "", 0, "", 0, 0, "", 0, 0, Replace(txt_kurs.Text, ",", ""), Trim(cbo_marketing.Text), "", "", "", "", 0, 0, 0, Replace(txt_disc.Text, ",", ""), Replace(txt_netto.Text, ",", ""), var_is_discbrand, var_is_disctype, var_is_disccat, var_is_discitem, 0, DataGridView1.Item(8, i).Value, DataGridView1.Item(9, i).Value, DataGridView1.Item(10, i).Value, Replace(txt_um.Text, ",", ""), Trim(cbo_acc.Text), Trim(cbo_curr_um.Text), Replace(txt_kurs.Text, ",", ""), cbo_ekspedisi.Text, Replace(TextBox1.Text, ",", ""), Format(txt_tgl_um.Value, "yyyy-MM-dd"), 0, 0)
            For i = 0 To DataGridView1.Rows.Count - 1
                If Trim(DataGridView1.Item(1, i).Value) <> "" Then
                    Call insert_sales_order_um(Trim(txt_so_no.Text), cbo_customer.Text, txt_date.Value, txt_comment.Text, Replace(txt_subtotal.Text, ",", ""), _
                                Replace(txt_tax.Text, "%", ""), Replace(txt_total.Text, ",", ""), username, server_datetime(), server_datetime(), username, _
                                DataGridView1.Item(0, i).Value, DataGridView1.Item(1, i).Value, DataGridView1.Item(3, i).Value, DataGridView1.Item(4, i).Value, DataGridView1.Item(5, i).Value, DataGridView1.Item(6, i).Value, DataGridView1.Item(7, i).Value, txt_curr.Text, 1, 0, Replace(txt_kurs.Text, ",", ""), Trim(cbo_marketing.Text), DataGridView1.Item(2, i).Value, DataGridView6.Item(1, i).Value, DataGridView6.Item(2, i).Value, DataGridView6.Item(4, i).Value, Replace(DataGridView3.Item(3, i).Value, ",", ""), Replace(DataGridView4.Item(3, i).Value, ",", ""), Replace(DataGridView5.Item(3, i).Value, ",", ""), Replace(txt_disc.Text, ",", ""), Replace(txt_netto.Text, ",", ""), var_is_discbrand, var_is_disctype, var_is_disccat, var_is_discitem, Replace(DataGridView6.Item(3, i).Value, ",", ""), DataGridView1.Item(8, i).Value, DataGridView1.Item(9, i).Value, DataGridView1.Item(10, i).Value, Replace(txt_um.Text, ",", ""), Trim(cbo_acc.Text), Trim(cbo_curr_um.Text), Replace(txt_kurs.Text, ",", ""), cbo_ekspedisi.Text, Replace(TextBox1.Text, ",", ""), Format(txt_tgl_um.Value, "yyyy-MM-dd"), Replace(DataGridView1.Item(11, i).Value, ",", ""), Replace(DataGridView1.Item(12, i).Value, ",", ""))
                End If
            Next
    ...
    Private Sub detail(ByVal criteria As String)
        ...
        If DT.Rows.Count > 0 Then
            ...
            For i = 0 To rows
                ...
                DataGridView1.Item(11, i).Value = FormatNumber(DT.Rows(i).Item("weight"), 0)
