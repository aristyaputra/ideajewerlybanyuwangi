...
Public Class frmPayUMSO
    ...
    Private Sub frmreceiptmoney_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Call insert_no_trans("PELUNASAN_SO", Month(txt_date.Value), Year(txt_date.Value))
        Call select_control_no("PELUNASAN_SO", "TRANS")
    ...
    Private Sub btn_save2_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btn_save2.Click
        open_conn()
        If insert = 1 Then
            If getTemplateAkses(username, "MN_SALES_UM_LUNAS_ADD") <> True Then
        ...
        If edit = 1 Then
            If getTemplateAkses(username, "MN_SALES_UM_LUNAS_EDIT") <> True Then
                Dim info As AlertInfo = New AlertInfo("Cek Kevaliditasan Data", "Anda tidak memiliki hak akses")
                alertControl_warning.Show(Me, info)
                Exit Sub
            End If
    ...
    Private Sub insert_data()
        ...
        Try
            ...
            If insert = 1 Then
                'Call delete_i_cogs()
                Call insert_pelunasan_so(Trim(txt_inv_no.Text), Format(txt_date.Value, "yyyy-MM-dd"), Lookup_Pelanggan.EditValue, _
                                ...
                                0, "", "", 0, "", 0, 0, Trim(txt_curr.Text), 0, 0, "INSERT", 0, var_po, Replace(txt_disc.Text, "%", ""), cbo_akun.Text, "", Replace(txt_kurs.Text, ",", ""), Replace(txt_um.Text, ",", ""), cbo_gudang.EditValue, 0, 0)
                For i = 0 To DataGridView1.Rows.Count - 1
                    Call insert_pelunasan_so(Trim(txt_inv_no.Text), Format(txt_date.Value, "yyyy-MM-dd"), "", "", 0, 0, 0, 0, 0, _
                                                        ...
                                                        txt_curr.Text, 1, i, "INSERT", 0, var_po, Replace(txt_disc.Text, "%", ""), cbo_akun.Text, DataGridView1.Item(2, i).Value, Replace(txt_kurs.Text, ",", ""), Replace(txt_um.Text, ",", ""), cbo_gudang.EditValue, Replace(DataGridView1.Item(9, i).Value, ",", ""), Replace(DataGridView1.Item(10, i).Value, ",", ""))
                ...
                If param_sukses = True Then
                    ...
                    update_no_trans(txt_date.Value, "PELUNASAN_SO")
            ...
            ElseIf edit = 1 Then
                ...
                Call update_pelunasan_so(Trim(txt_inv_no.Text), Format(txt_date.Value, "yyyy-MM-dd"), Lookup_Pelanggan.EditValue, _
                                var_id_supplier, var_pay_method, txt_payterm.Text, txt_discterm.Text, Replace(txt_disc_pay.Text, "%", ""), _
                                txt_subtotal.Text, txt_freight.Text, Replace(txt_tax.Text, "%", ""), txt_amount.Text, Trim(txt_comment.Text), _
                                username, Format(server_datetime(), "yyyy-MM-dd"), username, Format(server_datetime(), "yyyy-MM-dd"), _
                                0, "", "", 0, "", 0, 0, Trim(txt_curr.Text), 0, 0, "UPDATE", 0, var_po, Replace(txt_disc.Text, "%", ""), cbo_akun.Text, "", Replace(txt_kurs.Text, ",", ""), Replace(txt_um.Text, ",", ""), cbo_gudang.EditValue, 0, 0)
                For i = 0 To DataGridView1.Rows.Count - 1
                    Call update_pelunasan_so(Trim(txt_inv_no.Text), Format(txt_date.Value, "yyyy-MM-dd"), "", "", 0, 0, 0, 0, 0, _
                                                        0, 0, 0, "", "", Format(server_datetime(), "yyyy-MM-dd"), "", Format(server_datetime(), "yyyy-MM-dd"), _
                                                        DataGridView1.Item(0, i).Value, DataGridView1.Item(1, i).Value, DataGridView1.Item(3, i).Value, _
                                                        DataGridView1.Item(5, i).Value, DataGridView1.Item(6, i).Value, DataGridView1.Item(7, i).Value, DataGridView1.Item(8, i).Value, _
                                                        txt_curr.Text, 1, i, "UPDATE", 0, var_po, Replace(txt_disc.Text, "%", ""), cbo_akun.Text, DataGridView1.Item(2, i).Value, Replace(txt_kurs.Text, ",", ""), Replace(txt_um.Text, ",", ""), cbo_gudang.EditValue, Replace(DataGridView1.Item(9, i).Value, ",", ""), Replace(DataGridView1.Item(10, i).Value, ",", ""))
    ...
    Private Sub generate()
        ...
        edit = 1
        insert = 0
        cbo_gudang.EditValue = "WH001"
        DT = select_pelunasan_so("", noPurchase, 1, var_date, tglawal.Value, tglakhir.Value)
        Rows = DT.Rows.Count - 1
    ...
    Private Sub cbo_paymethod_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cbo_paymethod.SelectedIndexChanged
        ...
        If cbo_paymethod.Text = "Credit" Then
            ...
            If var_id_supplier <> Nothing Then
                cbo_akun.SelectedText = get_acc_piutang_cust(var_id_supplier)
            End If
        Else
    ...
    Private Sub btn_del2_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btn_del2.Click
        ...
        If edit = 1 Then
            ...
            If pesan = vbYes Then
                Call delete_pelunasan_so(Trim(txt_inv_no.Text), Format(txt_date.Value, "yyyy-MM-dd"), Lookup_Pelanggan.EditValue, _
                                var_id_supplier, var_pay_method, txt_payterm.Text, txt_discterm.Text, Replace(txt_disc_pay.Text, "%", ""), _
                                txt_subtotal.Text, txt_freight.Text, Replace(txt_tax.Text, "%", ""), txt_amount.Text, Trim(txt_comment.Text), _
                                username, Format(server_datetime(), "yyyy-MM-dd"), username, Format(server_datetime(), "yyyy-MM-dd"), _
                                0, "", "", 0, "", 0, 0, Trim(txt_curr.Text), 0, 0, "DELETE", 0, var_po, Replace(txt_disc.Text, "%", ""), cbo_akun.Text, "", Replace(txt_kurs.Text, ",", ""), Replace(txt_um.Text, ",", ""), cbo_gudang.EditValue, 0, 0)
                If param_sukses = True Then
    ...
    Private Sub view_data()
        ...
        Try
            ...
            Else
                var_date = 0
            End If
            DT = select_pelunasan_so(Trim(cbo_search.Text), Trim(txt_search.Text), 0, var_date, tglawal.Value, tglakhir.Value)
            GridControl.DataSource = DT
            GridList_Customer.Columns("no_purchase").Caption = "No Pelunasan"
            GridList_Customer.Columns("no_purchase").Width = 170
            GridList_Customer.Columns("nm_supplier").Caption = "Pelanggan"
            GridList_Customer.Columns("nm_supplier").Width = 200
            GridList_Customer.Columns("addr_supplier1").Visible = False
            GridList_Customer.Columns("no_purchase_order").Caption = "No SO"
    ...
    Private Sub view_data_po(ByVal Criteria As String)
        ...
        TSubTotal = 0
        If edit = 0 Then
            DT = select_so_pelunasan("No PO", Criteria, date_filter, Format(server_datetime(), "yyyy-MM-dd"), Format(server_datetime(), "yyyy-MM-dd"))
        Else
            DT = select_so_pelunasan_all("No PO", Criteria, date_filter, Format(server_datetime(), "yyyy-MM-dd"), Format(server_datetime(), "yyyy-MM-dd"))
        End If
        Rows = DT.Rows.Count - 1
        txt_freight.Text = FormatNumber(DT.Rows(0).Item("freight"), 0)
        txt_curr.Text = DT.Rows(0).Item("id_curr")
    ...
    Private Sub fillComboBoxAll()
        Dim DT As DataTable
        DT = select_list_so_pelunasan_all()
        ...
        Lookup_Pelanggan.Properties.View.Columns("id_supplier").Caption = "ID Customer"
        ...
        Lookup_Pelanggan.Properties.View.Columns("no_purchase_order").Caption = "No SO"
    End Sub

    Private Sub fillComboBox()
        Dim DT As DataTable
        DT = select_list_so_pelunasan()
        Lookup_Pelanggan.Properties.DataSource = DT
        Lookup_Pelanggan.Properties.DisplayMember = "id_supplier"
        Lookup_Pelanggan.Properties.ValueMember = "no_purchase_order"
        Lookup_Pelanggan.Properties.PopulateViewColumns()
        Lookup_Pelanggan.Properties.BestFitMode = DevExpress.XtraEditors.Controls.BestFitMode.BestFitResizePopup
        Lookup_Pelanggan.Properties.View.OptionsView.ShowAutoFilterRow = True
        Lookup_Pelanggan.Properties.View.Columns("id_supplier").Caption = "ID Customerr"
        Lookup_Pelanggan.Properties.View.Columns("supplier_name").Caption = "Nama"
        Lookup_Pelanggan.Properties.View.Columns("address").Caption = "Alamat"
        Lookup_Pelanggan.Properties.View.Columns("date_trn").Caption = "Tanggal"
        Lookup_Pelanggan.Properties.View.Columns("date_trn").DisplayFormat.FormatType = DevExpress.Utils.FormatType.DateTime
