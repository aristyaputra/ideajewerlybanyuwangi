...
Public Class frmARList
    ...
    Private Sub view_data()
        ...
        Try
            ...
            Dim var_t_lbhbyr As Double
            Dim date_filter As Integer

            If cbo_search.Text = "Invoice No" Then
                field = "no_sales"
            ElseIf cbo_search.Text = "Customer" Then
                field = "nama"
            End If
            ...
            ElseIf chk_date.Checked = False Then
                date_filter = 0
            End If
            DT = view_ar_status(date_filter, field, txt_search.Text, tglawal.Value, tglakhir.Value)
            ...
            For i = 0 To Rows
                ...
                var_t_lbhbyr = var_t_lbhbyr + DT.Rows(i).Item(9)
            Next
            ...
            txt_lbh_byr.Text = FormatNumber(var_t_lbhbyr, 0)
    ...
    Private Sub frmARList_Activated(sender As Object, e As System.EventArgs) Handles Me.Activated
        Me.WindowState = FormWindowState.Maximized
    End Sub

    Private Sub frmARList_FormClosed(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
        close_conn()
        MainMenu.Activate()
    End Sub
    ...
    'Private Sub frmARList_SizeChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.SizeChanged
    '    open_conn()
