...
Public Class FormNotaSO
    ...
    Private Sub Form1_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Try
            ...
            Dim qryCompanies As String = "SELECT * FROM view_ctk_so where no_sales_order = '" & frmso.NoBuktiSO & "'"
            ...
            R.Refresh()
            R.RecordSelectionFormula = "{view_ctk_so1.no_sales_order} ='" & frmso.NoBuktiSO & "'"
            With CRviewer
                .ReportSource = R
