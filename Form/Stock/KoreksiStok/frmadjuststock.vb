...
Public Class frmadjuststock
    ...
    Private Sub fillcombobox()
        Dim DT As DataTable
        DT = select_combo_opname()
        cbo_opname.Properties.DataSource = DT
        cbo_opname.Properties.DisplayMember = "no_opname"
        cbo_opname.Properties.ValueMember = "no_opname"
        cbo_opname.Properties.PopulateViewColumns()
        cbo_opname.Properties.BestFitMode = DevExpress.XtraEditors.Controls.BestFitMode.BestFitResizePopup
        cbo_opname.Properties.View.OptionsView.ShowAutoFilterRow = True
        cbo_opname.Properties.View.Columns("no_opname").Caption = "No Stok Opname"
        cbo_opname.Properties.View.Columns("date_trn").Caption = "Tanggal"
        cbo_opname.Properties.View.Columns("date_trn").DisplayFormat.FormatType = DevExpress.Utils.FormatType.DateTime
        cbo_opname.Properties.View.Columns("date_trn").DisplayFormat.FormatString = "dd-MMM-yyyy"
        cbo_opname.Properties.View.Columns("id_warehouse").Visible = False
    End Sub
    ...
    Private Sub view_detail_opname(ByVal Criteria As String)
        open_conn()
        Dim Rows As Integer
        Dim DT As DataTable
        ...
        date_filter = 0
        DT = select_stokopname_item(Criteria)
        ...
        If DT.Rows().Count > 0 Then
            For i = 0 To Rows
                ...
                DataGridView1.Item(4, i).Value = FormatNumber(DT.Rows(i).Item("qty_plus"), 0)
                DataGridView1.Item(5, i).Value = FormatNumber(DT.Rows(i).Item("qty_minus"), 0)
                DataGridView1.Item(6, i).Value = DT.Rows(i).Item("id_unit")
                DataGridView1.Item(7, i).Value = FormatNumber(DT.Rows(i).Item("weight_plus"), 2)
                DataGridView1.Item(8, i).Value = FormatNumber(DT.Rows(i).Item("weight_minus"), 2)
            Next
        End If
    End Sub
    ...
    Private Sub insert_data()
        ...
        If insert = 1 Then
            Call insert_adjust_stock(Trim(txt_no.Text), txt_date.Value, Trim(cbo_warehouse.Text), (Replace(txt_positif.Text, ",", "") - Replace(txt_negatif.Text, ",", "")), username, Format(server_datetime(), "yyyy-MM-dd"), _
                               Format(server_datetime(), "yyyy-MM-dd"), username, "", "", 0, 0, 0, 0, txt_command.Text, "", 0, 0)
            For i = 0 To DataGridView1.Rows.Count - 1
                If DataGridView1.Item(1, i).Value <> "" Or DataGridView1.Item(1, i).Value <> Nothing Then
                    ...
                    End If
                    Call insert_adjust_stock(Trim(txt_no.Text), txt_date.Value, Trim(cbo_warehouse.Text), (Replace(txt_positif.Text, ",", "") - Replace(txt_negatif.Text, ",", "")), username, Format(server_datetime(), "yyyy-MM-dd"), _
                               Format(server_datetime(), "yyyy-MM-dd"), username, DataGridView1.Item(1, i).Value, DataGridView1.Item(3, i).Value, DataGridView1.Item(4, i).Value, DataGridView1.Item(5, i).Value, i, 1, "", DataGridView1.Item(6, i).Value, Replace(DataGridView1.Item(7, i).Value, ",", ""), Replace(DataGridView1.Item(8, i).Value, ",", ""))
                End If
            Next
        ...
        ElseIf edit = 1 Then
            Call update_adjust_stock(Trim(txt_no.Text), txt_date.Value, Trim(cbo_warehouse.Text), (Replace(txt_positif.Text, ",", "") - Replace(txt_negatif.Text, ",", "")), username, Format(server_datetime(), "yyyy-MM-dd"), _
                               Format(server_datetime(), "yyyy-MM-dd"), username, "", DataGridView1.Item(3, i).Value, 0, 0, 0, 0, txt_command.Text, "", 0, 0)
            For i = 0 To DataGridView1.Rows.Count - 1
                If DataGridView1.Item(1, i).Value <> "" Or DataGridView1.Item(1, i).Value <> Nothing Then
                    If CInt(DataGridView1.Item(4, i).Value) > 0 And CInt(DataGridView1.Item(5, i).Value) <= 0 Then
                        var_nominal = CInt(DataGridView1.Item(4, i).Value)
    ...
    Public Sub detail(ByVal criteria As String)
        ...
        If DT.Rows.Count > 0 Then
            ...
            For i = 0 To rows
                ...
                DataGridView1.Item(6, i).Value = DT.Rows(i).Item("id_unit")
                DataGridView1.Item(7, i).Value = DT.Rows(i).Item("weight_plus")
                DataGridView1.Item(8, i).Value = DT.Rows(i).Item("weight_minus")
    ...
    Private Sub cbo_opname_EditValueChanged(sender As System.Object, e As System.EventArgs) Handles cbo_opname.EditValueChanged
        If cbo_opname.EditValue <> Nothing Then
            Dim rowSupplier As DataRowView
            rowSupplier = TryCast(cbo_opname.Properties.GetRowByKeyValue(cbo_opname.EditValue), DataRowView)
            cbo_warehouse.Text = rowSupplier.Item("id_warehouse").ToString
            view_detail_opname(cbo_opname.EditValue)
            hitung_total()
        End If
    End Sub
End Class