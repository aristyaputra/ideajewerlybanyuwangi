...
Module mdlPurchaseRequest_Update
    ...
    Public Sub update_approve_ro(ByVal var_no_request_order As String, ByVal var_id_item As String, ByVal var_date_trn As Date, ByVal var_qty As Integer)

        oTransaction = conn.BeginTransaction(IsolationLevel.ReadCommitted)

        With cmd_sqlupdate
            .Connection = conn
            .CommandText = "call sp_approve_ro ('" & var_no_request_order & "','" & var_id_item & "','" & Format(var_date_trn, "yyyy-MM-dd hh:mm:ss") & "'," & var_qty & ")"
            .CommandType = CommandType.Text
            .Transaction = oTransaction
        End With
        Try
