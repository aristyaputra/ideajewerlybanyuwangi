...
Module mdlMataUang_Delete
    ...
    Public Sub delete_currency(ByVal var_itemcat_id As String, ByVal var_itemcat_nm As String, ByVal var_nation As String, ByVal description As String, ByVal transid As String, ByVal flag As Integer)
