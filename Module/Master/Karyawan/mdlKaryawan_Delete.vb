...
Module mdlKaryawan_Delete
    ...
    Public Sub delete_marketing(ByVal var_id_marketing As String, ByVal var_first_name As String, ByVal var_last_name As String, _
        ...
        With cmd_sqldelete
            ...
            .CommandText = "call sp_marketing ('" & var_id_marketing & "','" & var_first_name & "','" & var_last_name & "','" & _
                                                ...
                                                Format(var_modified_date, "yyyy-MM-dd") & "','" & var_created_user & "','DELETE'," & var_status & ",'" & var_notes & "','" & var_grade & "'," & var_position & "," & var_department & ")"
