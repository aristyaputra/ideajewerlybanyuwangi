...
Module mdlCucian_Insert
    ...
    Public Sub process_cucian(ByVal var_no_purchase As String, ByVal var_date_trn As Date, ByVal var_id_item As String, ByVal var_qty As Integer, ByVal var_id_unit As String, ByVal var_price As Double, ByVal transid As String, ByVal detail As Integer)
        oTransaction = conn.BeginTransaction(IsolationLevel.ReadCommitted)

        With cmd_sqlinsert
            .Connection = conn
            .CommandText = "call sp_cucianinstok_inprocess ('" & var_no_purchase & "','" & Format(var_date_trn, "yyyy-MM-dd") & "','" & _
                                              var_id_item & "'," & var_qty & ",'" & var_id_unit & "'," & var_price & ",'INSERT', " & detail & ")"
            .CommandType = CommandType.Text
            .Transaction = oTransaction
        End With
        Try
