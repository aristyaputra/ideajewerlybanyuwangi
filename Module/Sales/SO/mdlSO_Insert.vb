...
Module mdlSO_Insert
    ...
    Public Sub insert_sales_order(ByVal var_no_sales_order As String, _
                              ...
                              ByVal var_ekspedisi As String, ByVal var_freight As Double, ByVal var_weight As Double, ByVal var_perweight As Double)
