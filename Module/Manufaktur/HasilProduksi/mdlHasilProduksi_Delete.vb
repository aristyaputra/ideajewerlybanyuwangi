...
Module mdlHasilProduksi_Delete
    Dim SqlDelete As String
    Dim cmd_sqldelete As New MySqlCommand
    Dim oTransaction As MySqlTransaction
    Dim var_photo_replace As String

    Public Sub delete_realisasi_wo(ByVal var_realisasi_no As String, _
                     ByVal var_wo_no As String, _
                     ...
                     ByVal var_total_cost_conversion As Double, ByVal var_detail As Integer, ByVal varloop As Integer, ByVal transid As String, ByVal var_id_warehouse As String)
        oTransaction = conn.BeginTransaction(IsolationLevel.ReadCommitted)

        With cmd_sqldelete
            .Connection = conn
            .CommandText = "call sp_wo_realized ('" & var_realisasi_no & "','" & var_wo_no & "','" & _
                                         ...
                                         Replace(var_total_cost_conversion, ",", "") & "," & var_detail & "," & varloop & ",'" & transid & "','" & var_id_warehouse & "')"
