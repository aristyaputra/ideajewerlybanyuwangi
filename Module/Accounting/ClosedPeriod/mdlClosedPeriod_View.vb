...
Module mdlClosedPeriod_View
    ...
    Public Function select_acc_close() As DataTable
        Dim DT As New DataTable

        Try
            With cmd_sqlselect
                .Connection = conn
                .CommandText = "select id_account from i_set_account_def where acc_parameter = 'acc_close_period'"
