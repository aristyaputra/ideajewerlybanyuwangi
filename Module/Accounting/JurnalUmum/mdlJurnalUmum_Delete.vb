...
Module mdlJurnalUmum_Delete
    Dim SqlDelete As String
    Dim cmd_sqldelete As New MySqlCommand
    Dim oTransaction As MySqlTransaction
    Dim var_photo_replace As String

    Public Sub delete_journal(ByVal var_no_journal As String, ByVal var_date_trn As Date, ByVal var_comment As String, ByVal created_user As String, _
