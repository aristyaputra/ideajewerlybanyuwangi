...
Module mdlJurnalPenyesuaian_Insert
    ...
    Public Sub insert_adj_journal(ByVal var_no_journal As String, ByVal var_date_trn As Date, ByVal var_comment As String, ByVal created_user As String, _
